...
export function GeospatialAppBarChartBasic() {
  return (
    <div className="bar-chart-basic" style={basicStyle}>
...
export function GeospatialAppBarChartMargins() {
  return (
    <div className="bar-chart-margins" style={basicStyle}>
      <XYPlot
        height={140}
        width={280}
...
export function GeospatialAppBarChartXDomain() {
  return (
    <div className="bar-chart-x-domain" style={basicStyle}>
      <XYPlot
        height={140}
        width={280}
        xDomain={[0, 24]}
...
export function GeospatialAppBarChartFormattedAxis() {
  return (
    <div className="bar-chart-formatted-axis" style={basicStyle}>
      <XYPlot
        height={140}
        width={280}
        xDomain={[0, 24]}
...
export function GeospatialAppBarChartYDomain() {
  return (
    <div className="bar-chart-y-domain" style={basicStyle}>
      <XYPlot height={140} width={280} yDomain={[0, 1000]}>
        <YAxis tickFormat={d => (d / 100).toFixed(0) + '%'} />
        <VerticalBarSeries data={pickups} />
        <XAxis />
      </XYPlot>
...
export function GeospatialAppBarChartCustomColor() {
  return (
    <div className="bar-chart-custom-color" style={basicStyle}>
      <XYPlot
        height={140}
        width={280}
        xDomain={[0, 24]}
...
export function GeospatialAppBasicLineChart() {
  return (
    <div className="line-chart-basic" style={basicStyle}>
      <XYPlot
        height={140}
        width={480}
        yDomain={[0, 1000]}
